...
<!-- css container -->
<div class="container_overmij">
    <!-- img -->
    <div class="back_grond_overmij">
        <!-- text -->
        <div class="row col-12">
            <div class="text_overmij text-center">
                <h1><?= $data['title-banner']; ?></h1>
            </div>
            <!-- <div class="container text-center">
                <div class="row">
                    <div class="col-lg-4 col-md-12 col-sm-12 ml-5">
                        <a href="https://open.spotify.com/track/62i3DHOW8yxQlbzOhGLnhX?si=Lcm18dH_R2eWdZH1npt_Rw" type="button">
